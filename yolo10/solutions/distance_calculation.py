...
from yolo10.utils.checks import check_imshow
from yolo10.utils.plotting import Annotator, colors
...
class DistanceCalculation:
    ...
    def display_frames(self):
        """Display frame."""
        cv2.namedWindow("yolo10 Distance Estimation")
        cv2.setMouseCallback("yolo10 Distance Estimation", self.mouse_event_for_distance)
        cv2.imshow("yolo10 Distance Estimation", self.im0)
