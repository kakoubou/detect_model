...
from yolo10.models.fastsam.utils import bbox_iou
from yolo10.models.yolo.detect.predict import DetectionPredictor
from yolo10.utils import DEFAULT_CFG, ops


class FastSAMPredictor(DetectionPredictor):
    """
    FastSAMPredictor is specialized for fast SAM (Segment Anything Model) segmentation prediction tasks in yolo10
    YOLO framework.
