...
from yolo10.nn.tasks import RTDETRDetectionModel
...
class RTDETR(Model):
    ...
    def task_map(self) -> dict:
        """
        Returns a task map for RT-DETR, associating tasks with corresponding yolo10 classes.

        Returns:
            dict: A dictionary mapping task names to yolo10 task classes for the RT-DETR model.
        """
        return {
            "detect": {
