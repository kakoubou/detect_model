...
using SAM. It forms an integral part of the yolo10 framework and is designed for high-performance, real-time image
segmentation tasks.
"""
...
class Predictor(BasePredictor):
    ...
    def setup_model(self, model, verbose=True):
        ...
        parameters for image normalization and other yolo10 compatibility settings.
