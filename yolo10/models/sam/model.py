...
This module provides an interface to the Segment Anything Model (SAM) from yolo10, designed for real-time image
...
from yolo10.utils.torch_utils import model_info
