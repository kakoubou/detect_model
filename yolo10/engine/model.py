...
from yolo10.cfg import TASK2DATA, get_cfg, get_save_dir
from yolo10.hub.utils import HUB_WEB_ROOT
from yolo10.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
from yolo10.utils import ASSETS, DEFAULT_CFG_DICT, LOGGER, RANK, SETTINGS, callbacks, checks, emojis, yaml_load
...
class Model(nn.Module):
    ...
    loaded from local files, yolo10 HUB, or Triton Server. The class is designed to be flexible and
    ...
    Args:
        model (Union[str, Path], optional): Path or name of the model to load or create. This can be a local file
            path, a model name from yolo10 HUB, or a Triton Server model. Defaults to 'yolov8n.pt'.
    ...
    Attributes:
        ...
        session (HUBTrainingSession): The yolo10 HUB session, if applicable.
    ...
    Methods:
        ...
        _get_hub_session: Retrieves or creates an yolo10 HUB session.
        is_triton_model: Checks if a model is a Triton Server model.
        is_hub_model: Checks if a model is an yolo10 HUB model.
    ...
    def __init__(
        ...
        sources, including local files, yolo10 HUB models, and Triton Server models. The method initializes several
        important attributes of the model and prepares it for operations like training, prediction, or export.

        Args:
            model (Union[str, Path], optional): The path or model file to load or create. This can be a local
                file path, a model name from yolo10 HUB, or a Triton Server model. Defaults to 'yolov8n.pt'.
        ...
        # Check if yolo10 HUB model from https://hub.yolo10.com
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[yolo10.engine.results.Results]): A list of prediction results, encapsulated in the Results class.
        """
    ...
    def _get_hub_session(model: str):
        ...
        from yolo10.hub.session import HUBTrainingSession
    ...
    def is_hub_model(model: str) -> bool:
        ...
        return any(
            (
                model.startswith(f"{HUB_WEB_ROOT}/models/"),  # i.e. https://hub.yolo10.com/models/MODEL_ID
    ...
    def reset_weights(self) -> "Model":
        ...
        Returns:
            self (yolo10.engine.model.Model): The instance of the class with reset weights.
    ...
    def load(self, weights: Union[str, Path] = "yolov8n.pt") -> "Model":
        ...
        Returns:
            self (yolo10.engine.model.Model): The instance of the class with loaded weights.
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt", use_dill=True) -> None:
        ...
        """
        self._check_is_pytorch_model()
        from yolo10 import __version__
        from datetime import datetime

        updates = {
            "date": datetime.now().isoformat(),
            "version": __version__,
            "license": "AGPL-3.0 License (https://yolo10.com/license)",
            "docs": "https://docs.yolo10.com",
        }
    ...
    def predict(
        ...
        **kwargs,
        ...
        is_cli = (sys.argv[0].endswith("yolo") or sys.argv[0].endswith("yolo10")) and any(
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[yolo10.engine.results.Results]): A list of tracking results, encapsulated in the Results class.

        Raises:
            AttributeError: If the predictor does not have registered trackers.
        """
        if not hasattr(self.predictor, "trackers"):
            from yolo10.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        It uses the 'benchmark' function from the yolo10.utils.benchmarks module. The benchmarking is configured
        ...
        """
        self._check_is_pytorch_model()
        from yolo10.utils.benchmarks import benchmark
    ...
    def train(
        ...
        **kwargs,
        ...
        different scenarios, such as resuming training from a checkpoint, integrating with yolo10 HUB, and
        updating model and configuration after training.

        When using yolo10 HUB, if the session already has a loaded model, the method prioritizes HUB training
        ...
        """
        self._check_is_pytorch_model()
        if hasattr(self.session, "model") and self.session.model.id:  # yolo10 HUB session with loaded model
            if any(kwargs):
    ...
    def tune(
        ...
        **kwargs,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the yolo10.utils.tuner module.
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from yolo10.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        using the 'check_class_names' function from the yolo10.nn.autobackend module.

        Returns:
            (list | None): The class names of the model if available, otherwise None.
        """
        from yolo10.nn.autobackend import check_class_names
