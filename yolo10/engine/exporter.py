...
from yolo10.cfg import get_cfg
from yolo10.data.dataset import YOLODataset
from yolo10.data.utils import check_det_dataset
from yolo10.nn.autobackend import check_class_names, default_class_names
from yolo10.nn.modules import C2f, Detect, RTDETRDecoder, v10Detect
from yolo10.nn.tasks import DetectionModel, SegmentationModel, WorldModel
...
from yolo10.utils.checks import PYTHON_VERSION, check_imgsz, check_is_path_safe, check_requirements, check_version
from yolo10.utils.downloads import attempt_download_asset, get_github_assets
from yolo10.utils.files import file_size, spaces_in_path
from yolo10.utils.ops import Profile
from yolo10.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device, smart_inference_mode
...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        if isinstance(model, WorldModel):
            LOGGER.warning(
                ...
                "See https://docs.yolo10.com/models/yolo-world for details."
            )
        ...
        description = f'yolo10 {self.pretty_name} model {f"trained on {data}" if data else ""}'
        self.metadata = {
    ...
    def export_engine(self, prefix=colorstr("TensorRT:")):
        ...
        f_onnx, _ = self.export_onnx()  # run before TRT import https://github.com/yolo10/yolo10/issues/7016
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        ...
        check_version(
            ...
            name="tensorflow",
            verbose=True,
            msg="https://github.com/yolo10/yolo10/issues/5161",
        )
        import onnx2tf
    ...
    def export_edgetpu(self, tflite_model="", prefix=colorstr("Edge TPU:")):
        ...
        LOGGER.warning(f"{prefix} WARNING ⚠️ Edge TPU known bug https://github.com/yolo10/yolo10/issues/1185")
...
class IOSDetectModel(torch.nn.Module):
    """Wrap an yolo10 YOLO model for Apple iOS CoreML export."""
