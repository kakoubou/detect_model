...
from yolo10.utils.tal import TORCH_1_10, dist2bbox, dist2rbox, make_anchors
...
class Detect(nn.Module):
    ...
    def inference(self, x):
        ...
        if self.export and self.format in ("tflite", "edgetpu"):
            ...
            # See https://github.com/yolo10/yolo10/issues/7371
            grid_h = shape[2]
            grid_w = shape[3]
...
class RTDETRDecoder(nn.Module):
    ...
    def forward(self, x, batch=None):
        ...
        from yolo10.models.utils.ops import get_cdn_group
