...
from yolo10 import Explorer
from yolo10.utils import ROOT, SETTINGS
...
def utralytics_explorer_docs_callback():
    ...
    with st.container(border=True):
        st.image(
            "https://raw.githubusercontent.com/yolo10/assets/main/logo/yolo10_Logotype_Original.svg",
            width=100,
        )
        st.markdown(
            "<p>This demo is built using yolo10 Explorer API. Visit <a href='https://docs.yolo10.com/datasets/explorer/'>API docs</a> to try examples & learn more</p>",
            unsafe_allow_html=True,
            help=None,
        )
        st.link_button("Ultrlaytics Explorer API", "https://docs.yolo10.com/datasets/explorer/")


def layout():
    """Resets explorer session variables and provides documentation with a link to API docs."""
    st.set_page_config(layout="wide", initial_sidebar_state="collapsed")
    st.markdown("<h1 style='text-align: center;'>yolo10 Explorer Demo</h1>", unsafe_allow_html=True)
