...
"""
MLflow Logging for yolo10 YOLO.

This module enables MLflow logging for yolo10 YOLO. It logs metrics, parameters, and model artifacts.
...
from yolo10.utils import LOGGER, RUNS_DIR, SETTINGS, TESTS_RUNNING, colorstr
...
def on_pretrain_routine_end(trainer):
    ...
    Args:
        trainer (yolo10.engine.trainer.BaseTrainer): The training object with arguments and parameters to log.
