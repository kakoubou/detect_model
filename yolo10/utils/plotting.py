...
from yolo10.utils import LOGGER, TryExcept, ops, plt_settings, threaded
...
class Colors:
    """
    yolo10 default color palette https://yolo10.com/.

    This class provides methods to work with the yolo10 color palette, including converting hex color codes to
    RGB values.
...
class Annotator:
    """
    yolo10 Annotator for train/val mosaics and JPGs and predictions annotations.
...
@TryExcept()  # known issue https://github.com/yolo10/yolov5/issues/5395
@plt_settings()
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from yolo10.utils.plotting import save_one_box
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/yolo10/yolov5/issues/7007 chroma subsampling issue
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ```python
        from yolo10.utils.plotting import plot_results
